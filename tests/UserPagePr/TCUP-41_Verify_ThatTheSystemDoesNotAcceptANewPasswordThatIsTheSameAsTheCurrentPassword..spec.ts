...
test.skip('TCUP_41:UserPage | Verify that the system does not accept a new password that is the same as the current password.', async ({ page }) => {
    ...
    const newPassword= "Mail@123";
    const confrimPassword= "Mail@123";
