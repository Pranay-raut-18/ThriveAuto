...
test("TCCP_08:CustomerPage | verify filter functionality by Customer Type 'Enterprise'", async ({
  page,
}) => {
  ...
  //Verify all the records of Customer Filtered by customer Type "Enterprise"
