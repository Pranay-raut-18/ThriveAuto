...
test("TCCP_10:CustomerPage | verify filter functionality by Customer Type 'Private Equity'", async ({
  page,
}) => {
  ...
  //Verify all the records of Customer Filtered by customer Type "Private Equity"
