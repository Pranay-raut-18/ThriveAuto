...
test("TCCP_13:CustomerPage | Verify filter functionality by Status 'Pending' ", async ({
  page,
}) => {
  ...
  await test.step(`Select the Status to "Pending"`, async () => {
  ...
  //Verify all the records of Customer Filtered by Status is "Pending"
