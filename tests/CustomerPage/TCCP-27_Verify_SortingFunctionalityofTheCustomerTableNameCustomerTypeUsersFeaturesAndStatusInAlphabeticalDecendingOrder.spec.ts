...
test("TCCP_27: CustomerPage | Verify the Sorting functionality of the Customer table Name, Customer type, Users, Features and Status in alphabetical, Descending order", async ({
  page,
}) => {
  ...
  //Go to Name in the table and Double Click Sorting button next to it (↑).
  await test.step(`Go to Name in the table and Double Click Sorting button next to it (↑).`, async () => {
  ...
  //Go to Customer type in the table and Double click Sorting button next to it (↑).
  await test.step(`Go to Customer type in the table and Double click Sorting button next to it (↑).`, async () => {
  ...
  //Go to Users in the table and Double click Sorting button next to it (↑).
  await test.step(`Go to Users in the table and Double click Sorting button next to it (↑).`, async () => {
  ...
  //Go to Features in the table and Double click Sorting button next to it (↑).
  await test.step(`Go to Features in the table and Double click Sorting button next to it (↑).`, async () => {
  ...
  //Go to Status in the table and Double click Sorting button next to it (↑).
  await test.step(`Go to Status in the table and Double click Sorting button next to it (↑).`, async () => {
