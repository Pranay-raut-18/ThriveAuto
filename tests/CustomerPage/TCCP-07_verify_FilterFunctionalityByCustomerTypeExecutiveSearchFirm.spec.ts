...
test("TCCP_07:CustomerPage | verify filter functionality by Customer Type Executive Search Firm", async ({
  page,
}) => {
  ...
  //Verify all the records of Customer Filtered by customer Type "Executive Search Firm"
